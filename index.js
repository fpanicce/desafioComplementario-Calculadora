...
const calculadora = (numero1, numero2) =>{
    ...
    if(accion == 1){
        numero1 = Number(prompt("Ingresa el numero 1"))
        numero2 = Number(prompt("Ingresa el numero 2"))
        ...
        numero1 = Number(prompt("Ingresa el numero al que quieres calcularle el factorial"))
